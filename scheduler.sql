...
CREATE TABLE `history_subcriber`  (
  ...
  `id_subcriber` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
INSERT INTO `history_subcriber` VALUES (2, 'SUB20211217164918542141', '2021-12-01', '22:55:01', 'GAGAL');
...
-- ----------------------------
INSERT INTO `parameter` VALUES (1, 'SMS-TWILIO', 'sid', 'AC1eff6d3633fad6a26477f1da516ce918234');
INSERT INTO `parameter` VALUES (2, 'SMS-TWILIO', 'token', '3f77d92b23395f3a026826c0f483bf35565');
...
INSERT INTO `parameter` VALUES (8, 'EMAIL-GMAIL', 'from.password', '*******');
...
INSERT INTO `subscriber` VALUES ('SUB20211217164918542141', 'Anja An', 'irawanpapang@gmail.com', '+62838323241213', 'SMS', NULL);
